...
**Afternoon Axiom** sent 47 cold emails. Same message, slight variations. GitHub search → find repo → extract commit email → compose Gmail URL → Cmd+Enter → close tab → repeat. For four hours straight.
